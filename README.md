# Extended Generative AI Conversation
This is custom component of Home Assistant.

Derived from [OpenAI Conversation](https://www.home-assistant.io/integrations/openai_conversation/) but migrated to use Google's Generative AI (Gemini) with similar features such as call-service.
...
- Option to pass the current user's name to Generative AI via the user message context

## How it works
Extended Generative AI Conversation uses Google's Generative AI API's function calling capability to call services of Home Assistant.

Since Generative AI models already know how to call services of Home Assistant in general, you just have to let the model know what devices you have by [exposing entities](https://github.com/jekalmin/extended_generativeai_conversation#preparation)

## Installation
1. Install via registering as a custom repository of HACS or by copying `extended_generativeai_conversation` folder into `<config directory>/custom_components`
2. Restart Home Assistant
3. Go to Settings > Devices & Services.
4. In the bottom right corner, select the Add Integration button.
5. Follow the instructions on screen to complete the setup (API Key is required).
    - [Getting a Google Generative AI API Key](https://ai.google.dev/tutorials/setup)
    - Specify "Base Url" if using a different endpoint, otherwise leave as it is.
6. Go to Settings > [Voice Assistants](https://my.home-assistant.io/redirect/voice_assistants/).
7. Click to edit Assistant (named "Home Assistant" by default).
8. Select "Extended Generative AI Conversation" from "Conversation agent" tab.
    <details>

    <summary>guide image</summary>
    <img width="500" alt="Assistant Configuration" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/0849d241-0b82-47f6-9956-fdb82d678aca">
...
https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/938dee95-8907-44fd-9fb8-dc8cd559fea2

### 2. Turn on multiple entities
https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/528f5965-94a7-4cbe-908a-e24f7bbb0a93

### 3. Hook with custom notify function
https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/4a575ee7-0188-41eb-b2db-6eab61499a99

### 4. Add automation
https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/04b93aa6-085e-450a-a554-34c1ed1fbb36

### 5. Play Netflix 
https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/64ba656e-3ae7-4003-9956-da71efaf06dc

## Configuration
### Options
By clicking a button from Edit Assist, Options can be customized.<br/>
Options include standard conversation agent options and two new options. 

- `Attach Username`: Pass the active user's name (if applicable) to Generative AI via the message payload. Currently, this only applies to conversations through the UI or REST API.
...
- `Functions`: A list of mappings of function spec to function.
  - `spec`: Function specification that defines the function's parameters and behavior.
  - `function`: function that will be called.


| Edit Assist                                                                                                                                  | Options                                                                                                                                                                       |
|----------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img width="608" alt="1" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/bb394cd4-5790-4ac9-9311-dbcab0fcca56"> | <img width="591" alt="Options Screenshot" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/431e4bc5-87a0-4d7b-8da0-6273f955877f"> |


### Functions

#### Supported function types
- `native`: built-in function provided by "extended_generativeai_conversation".
...
Then you will be able to let the model call your function. 

### 1. template
#### 1-1. Get current weather

For real world example, see [weather](https://github.com/jekalmin/extended_generativeai_conversation/tree/main/examples/function/weather).<br/>
...
<img width="300" alt="Example conversation" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/05e31ea5-daab-4759-b57d-9f5be546bac8">
...
<img width="300" alt="Shopping cart example" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/89060728-4703-4e57-8423-354cdc47f0ee">

#### 2-2. Send messages to another messenger

In order to accomplish "send it to Line" like [example3](https://github.com/jekalmin/extended_generativeai_conversation#3-hook-with-custom-notify-function), register a notify function like below.
...
<img width="300" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/16dc4ca0-c823-4dfe-a2b7-1ba7623acc70">

#### 2-3. Get events from calendar

In order to pass result of calling service to the model, set response variable to `_function_result`. 
...
<img width="300" alt="Calendar example" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/7a6c6925-a53e-4363-a93c-45f63951d41b">
...
<img width="300" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/d5c9e0db-8d7c-4a7a-bc46-b043627ffec6">
...
<img width="300" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/346065d3-7ab9-49c8-ba30-b79b37a5f084">

### 3. native

#### 3-1. Add automation

Before adding automation, I highly recommend set notification on `automation_registered_via_extended_generativeai_conversation` event and create separate "Extended Generative AI Assistant" and "Assistant"
...
|----------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img width="830" alt="1" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/b7030a46-9a4e-4ea8-a4ed-03d2eb3af0a9"> | <img width="1116" alt="Notify on created" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/7afa3709-1c1d-41d0-8847-70f2102d824f"> |
...
<img width="300" alt="Add automation example" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/55f5fe7e-b1fd-43c9-bce6-ac92e203598f">
...
<img width="300" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/32217f3d-10fc-4001-9028-717b1683573b">
...
<img width="300" alt="HA version example" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/e640c3f3-8d68-486b-818e-bd81bf71c2f7">
...
<img width="300" alt="REST API example" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/f968e328-5163-4c41-a479-76a5406522c1">
...
<img width="300" alt="YouTube Music search" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/648efef8-40d1-45d2-b3f9-9bac4a36c517">
...
- Without examples, a query tries to fetch data only from "states" table like below
  > Question: When did bedroom light turn on? <br/>
    Query(generated by model): SELECT * FROM states WHERE entity_id = 'input_boolean.livingroom_light_2' AND state = 'on' ORDER BY last_changed DESC LIMIT 1
...
--|--
<img width="300" alt="Last changed example" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/5a25db59-f66c-4dfd-9e7b-ae6982ed3cd2"> |<img width="300" alt="State at time example" src="https://github.com/jekalmin/extended_generativeai_conversation/assets/2917984/51faaa26-3294-4f96-b115-c71b268b708e"> 


**FAQ**
1. Can the model modify or delete data?
    > No, since connection is created in a read only mode, data are only used for fetching. 
2. Can the model query data that are not exposed in database?
...
## Practical Usage
See more practical [examples](https://github.com/jekalmin/extended_generativeai_conversation/tree/main/examples).
...
logger:
  logs:
    custom_components.extended_generativeai_conversation: info
```
